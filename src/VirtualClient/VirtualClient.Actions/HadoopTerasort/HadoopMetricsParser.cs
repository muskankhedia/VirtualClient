...
namespace VirtualClient.Actions
{
    ...
    public class HadoopMetricsParser : MetricsParser
    {
        ...
        /// </summary>
        private static readonly Regex GeekBenchDataTableDelimiter = new Regex(@"=", RegexOptions.ExplicitCapture);
        ...
        {
            this.Preprocess();
            this.Sections = TextParsingExtensions.Sectionize(this.PreprocessedText, HadoopMetricsParser.GeekBenchSectionDelimiter);
        ...
        private void ParseFileSystemCounters()
        {
            ...
            this.FileSystemCounters = DataTableExtensions.ConvertToDataTable(
                this.Sections[sectionName], HadoopMetricsParser.GeekBenchDataTableDelimiter, sectionName, columnNames);
        }
